!(function (t, e) {
	...
	function ft(t, e) {
		var n = Z(),
			o = K(),
			i = F();
		e.showConfirmButton || e.showCancelButton ? O(n) : T(n),
	...
	(yt.text =
		...
		(yt.range = function (t) {
			...
			return (
				(n.value = t.inputValue), (n.type = t.input), (o.value = t.inputValue), e
			);
		}),
	...
	function wt(t, e) {
		...
		e.html
			? (tt(e.html, n), O(n, "block"))
			: e.text
			? ((n.textContent = e.text), O(n, "block"))
			: T(n),
			(function (t, e) {
				for (
		...
		Tt = function () {
			return new Promise(function (t) {
				...
				(Ot.restoreFocusTimeout = setTimeout(function () {
					Ot.previousActiveElement && Ot.previousActiveElement.focus
						? (Ot.previousActiveElement.focus(),
						  (Ot.previousActiveElement = null))
	...
	function It() {
		...
		t.showConfirmButton || (T(e.confirmButton), t.showCancelButton || T(e.actions)),
	...
	function Ft(t, e, n) {
		e
			...
			: (Tt().then(function () {
			  ...
			  (Ot.keydownHandlerAdded = !1)),
			delete Ot.keydownHandler,
			delete Ot.keydownTarget,
	...
	function Qt(t) {
		...
		if (n && !S(n, k.hide)) {
			...
			ot(n, k.show),
				nt(n, k.hide),
				dt && j(n)
					? n.addEventListener(dt, Zt.bind(null, n, e, st(), a))
					: Ft(e, st(), a),
	...
	function ne(t) {
		...
		null !== t.onBeforeOpen &&
			...
			st() ||
				...
				(Ot.previousActiveElement = document.activeElement),
			null !== t.onOpen &&
		...
		se = Object.freeze({
			...
			_main: function (t) {
				...
				!(function (e) {
					...
					Object.freeze(l),
					Ot.timeout && (Ot.timeout.stop(), delete Ot.timeout),
					clearTimeout(Ot.restoreFocusTimeout);
				var d = {
					popup: rt(),
					container: q(),
					content: U(),
				...
				return new Promise(function (t) {
					...
					Kt.swalPromiseResolve.set(c, t),
						l.timer &&
							(Ot.timeout = new Gt(function () {
					...
					l.reverseButtons
						...
						Ot.keydownTarget &&
							...
							(Ot.keydownTarget.removeEventListener(
								"keydown",
								Ot.keydownHandler,
								{capture: Ot.keydownListenerCapture}
							),
						...
						l.toast ||
							...
							(Ot.keydownTarget = l.keydownListenerCapture
								? window
								: d.popup),
							(Ot.keydownListenerCapture = l.keydownListenerCapture),
							Ot.keydownTarget.addEventListener(
								"keydown",
								Ot.keydownHandler,
								{capture: Ot.keydownListenerCapture}
							),
							(Ot.keydownHandlerAdded = !0)),
						c.enableButtons(),
						c.hideLoading(),
						c.resetValidationMessage(),
