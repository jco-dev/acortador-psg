!(function (l) {
	...
	(o.prototype.respChart = function (a, r, e, t) {
						...
						datasets: [
							{
								...
								data: [
									65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81, 56,
									89, 40, 32, 65, 59, 80, 81, 56, 89, 40, 32, 65, 59,
									80, 81, 56, 89, 40,
								],
							},
						],
				...
				this.respChart(
					...
					"Doughnut",
					{
						...
						datasets: [
							{
								data: [300, 50, 100],
								backgroundColor: ["#02a8b5", "#fa5c7c", "#ebeff2"],
								...
								xAxes: [
									{
										display: !0,
										gridLines: {zeroLineColor: "transparent"},
										ticks: {padding: 5, fontStyle: "bold"},
									},
								],
							},
						}
		...
		(o.prototype.init = function () {
			l("#datatable").DataTable({pageLength: 5, searching: !1, lengthChange: !1}),
				l("#usa").vectorMap({
					map: "usa_en",
					enableZoom: !0,
					showTooltip: !0,
